...
export function getRoute( route: Routes.CHANNELS | Routes.CONFIGURATIONS | Routes.FOLLOW | Routes.GUILDS | Routes.PROFILES, replace: Replacer<'guildId'> ): string
